-- Database Seeder for Racom POS
-- Populates database with ~1 month of realistic operations
-- Run this in Supabase SQL Editor

-- ============================================
-- PART 1: Clean existing data (optional)
-- ============================================
-- Uncomment to start fresh:
-- TRUNCATE sales_items, sales, inventory, products, categories, stores, user_stores, user_profiles CASCADE;

-- ============================================
-- PART 2: Create Stores
-- ============================================
-- Note: Adjust IDs if you already have stores
INSERT INTO stores (id, name, is_active) VALUES
('2860cccf-1b3a-471a-9b9f-ed5a5716f659', 'Tienda Principal', true),
('a1b2c3d4-e5f6-4a5b-8c9d-0e1f2a3b4c5d', 'Sucursal Norte', true),
('b2c3d4e5-f6a7-4b5c-9d0e-1f2a3b4c5d6e', 'Bodega Central', true)
ON CONFLICT (id) DO NOTHING;

-- ============================================
-- PART 3: Create Categories
-- ============================================
...
-- ============================================
-- PART 4: Create Products (50 products)
-- ============================================
...
-- ============================================
-- PART 6: Generate Sales (Last 30 Days)
-- ============================================
-- This will generate ~300-500 sales across the month
...
-- ============================================
-- PART 7: Generate Sale Items
-- ============================================
WITH sales_list AS (
  SELECT id, sale_date FROM sales WHERE total = 0
),
product_list AS (
...
-- ============================================
-- PART 8: Update Inventory Based on Sales
-- ============================================
