-- ========================================================
-- RPC: process_manda2_checkout (VERSIÓN CORREGIDA)
...
BEGIN
    ...
    -- Nota: Usamos 'total' en lugar de 'total_amount' según el esquema inicial
    ...
    LOOP
        ...
        -- Nota: Usamos 'price' y 'subtotal' según el esquema inicial
        ...
        -- 4. Opcional: Actualizar timestamp del producto
