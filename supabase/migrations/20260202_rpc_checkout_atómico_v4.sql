-- ========================================================
-- RPC: process_manda2_checkout (VERSIÓN V4 - SCHEMA MINIMAL)
-- Procesa una venta completa de forma atómica
-- Ajustado para: SIN columna 'status', CON 'source' y 'customer_name'
-- ========================================================
...
BEGIN
    ...
    -- Eliminamos 'status' ya que parece no existir en la tabla real
    ...
    LOOP
        ...
        -- 4. Mantener sincronizada la tabla de productos (si existe la columna stock_quantity)
        IF EXISTS (
